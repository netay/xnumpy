...
def main():
    ...
    print(
        ...
        '1st method\n'
        'x_1\n'
        f'float: {float(x1_ff64_v1):.12f} {float(x1_ff64_v1):.15e}\n'
        f'ff64:  {x1_ff64_v1:.12f} {x1_ff64_v1:.15e}\n'
        f'dec:   {x1_dec_v1:.12f} {x1_dec_v1:.15e}\n'
        'x_2\n'
        f'float: {float(x2_ff64_v1):+.15f} {float(x2_ff64_v1):+.15e}\n'
        f'ff64:  {x2_ff64_v1:+.15f} {x2_ff64_v1:+.15e}\n'
        f'dec:   {x2_dec_v1:+.15f} {x2_dec_v1:+.15e}\n'
        '2nd method\n'
        'x_1\n'
        f'float: {float(x1_ff64_v2):.12f} {float(x1_ff64_v2):.15e}\n'
        f'ff64:  {x1_ff64_v2:.12f} {x1_ff64_v2:.15e}\n'
        f'dec:   {x1_dec_v2:.12f} {x1_dec_v2:.15e}\n'
        'x_2\n'
        f'float: {float(x2_ff64_v2):+.15f} {float(x2_ff64_v2):+.15e}\n'
        f'ff64:  {x2_ff64_v2:+.15f} {x2_ff64_v2:+.15e}\n'
        f'dec:   {x2_dec_v2:+.15f} {x2_dec_v2:+.15e}\n'
    )
